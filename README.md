...
3. [Documento de requisitos](#Documento-de-requisitos)
	1. [Requisitos funcionais](##Requisitos-funcionais)
		...
		2. [RF2 - Registrar e armazenar anamnese digital](###RF2---Registra-e-armazenar-anamnese-digital)
...
5. [Casos de uso](#Casos-de-uso)
	...
	3. [Consultar a agenda de consultas (horários disponíveis e ocupados)](##Consultar-a-agenda-e-consultas-(horários-disponíveis-e-ocupados))
